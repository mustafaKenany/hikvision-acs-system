...
namespace PreviewDemo
{
    ...
    public partial class CHCNetSDK
    {
        ...
        **************************************************/
        ...
        public const int NET_DVR_SET_WIFI_CFG = 306;//����IP_�豸���߲���
        public const int NET_DVR_GET_WIFI_CFG = 307;//��ȡIP_�豸���߲���
        public const int NET_DVR_SET_WIFI_WORKMODE = 308;//����IP_�豸���ڹ���ģʽ����
        public const int NET_DVR_GET_WIFI_WORKMODE = 309;//��ȡIP_�豸���ڹ���ģʽ���� 
        public const int NET_DVR_GET_WIFI_STATUS = 310;	//��ȡ�豸��ǰwifi����״̬

        /***************************���ܷ����� begin *****************************/
        //�����豸����
        public const int DS6001_HF_B = 60;//�쳣��Ϊ��⣺DS6001-HF/B
        public const int DS6001_HF_P = 61;//����ʶ��DS6001-HF/P
        public const int DS6002_HF_B = 62;//˫��_��DS6002-HF/B
        public const int DS6101_HF_B = 63;//�쳣��Ϊ��⣺DS6101-HF/B
        ...
        public const int VCA_CHAN_ABILITY = 272;//�쳣��Ϊ�������
        ...
        //��Ϊ��Ӧ��NET_VCA_RULECFG��
        public const int NET_DVR_SET_RULECFG = 152;//�����쳣��Ϊ������
        public const int NET_DVR_GET_RULECFG = 153;//��ȡ�쳣��Ϊ������
        ...
        public const int NET_VCA_GET_RULECFG_V41 = 5011; //��ȡ�쳣��Ϊ������
        public const int NET_VCA_SET_RULECFG_V41 = 5012; //�����쳣��Ϊ������
        ...
        public const int COMM_ALARM_RULE = 0x1102;//�쳣��Ϊ��ⱨ����Ϣ����ӦNET_VCA_RULE_ALARM
        ...
        **************************************************/
        ...
        public const int WARNONMONITOR = 0x1;/*��ʾ���Ͼ���*/
        ...
        public struct NET_DVR_ALARMINFO_V40
       {
        ...
        public struct NET_DVR_DEV_CHAN_INFO
        {
            ...
            public byte[] byDomain;	//�豸����
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] sUserName;	//_������½�ʺ�
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = PASSWD_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] sPassword;	//_��������
        }
        ...
        public struct NET_DVR_DEVICEINFO_V40
        {
            ...
            public byte byPasswordLevel;      //admin���밲ȫ�ȼ�0-��Ч��1-Ĭ�����룬2-��Ч����,3-���սϸߵ����롣���û�������Ϊ����Ĭ�����루_�����߷��սϸߵ�����ʱ���ϲ�ͻ�����Ҫ��ʾ�û��������롣      
        ...
        {
            // Originally a union (LayoutKind.Explicit) — changed to Sequential
            // because managed byte[] fields cannot overlap in CLR explicit layout.
        ...
        public struct NET_VCA_DEV_ABILITY
        {
            ...
            //bySupport & 0x1����ʾ�Ƿ�֧������_ 2012-3-22
            ...
            public byte byFSnapBFullChanNum;  //����ץ�ĺ��쳣��Ϊ���ͨ������
        ...
        {
            VCA_BEHAVIOR_BASE = 1,          //�쳣��Ϊ��������
            VCA_BEHAVIOR_ADVANCE = 2,          //�쳣��Ϊ���߼���
            VCA_BEHAVIOR_FULL = 3,          //�쳣��Ϊ���������
            VCA_PLATE = 4,          //��������
            VCA_ATM = 5,          //ATM����
            VCA_PDC = 6,          //������ͳ��
            VCA_ITS = 7,          //���� ��ͨ�¼�
            VCA_BEHAVIOR_PRISON = 8,          //�쳣��Ϊ��������(����) 
            VCA_FACE_SNAP = 9,           //����ץ������
            VCA_FACE_SNAPRECOG = 10,          //����ץ�ĺ�ʶ������
            VCA_FACE_RETRIEVAL = 11,          //�������������
            VCA_FACE_RECOG = 12,          //����ʶ������
            VCA_BEHAVIOR_PRISON_PERIMETER = 13, // �쳣��Ϊ�������� (�ܽ�)
            VCA_TPS = 14,          //��ͨ�յ�
            VCA_TFS = 15,          //��·Υ��ȡ֤
            VCA_BEHAVIOR_FACESNAP = 16           //����ץ�ĺ��쳣��Ϊ�������
        }
        ...
        public struct NET_VCA_ONE_RULE
        {
            ...
            public VCA_EVENT_TYPE dwEventType;//�쳣��Ϊ����¼�����
            public NET_VCA_EVENT_UNION uEventParam;//�쳣��Ϊ����¼�����
        ...
        public struct NET_DVR_TRACK_CFG
        {
            ...
            public byte byDomeCalibrate;			//��������_����궨��1���� 0������ 
            public byte byRes;					// �����ֽ�
        ...
        {
            public uint dwSize;		//�ṹ����
            public byte byTrackMode;   //_ģʽ
            public byte byRuleConfMode;   //��������_ģʽ0-��������_��1-Զ������_
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;   //��������0
            [StructLayout(LayoutKind.Explicit)]
        ...
        public struct EVENT_VCA_BYVALUE
        {
            ...
            public byte byRuleID;      //�쳣��Ϊ������ͣ�����0xff��ʾȫ������0��ʼ
        ...
        public struct NET_DVR_VCA_CTRLINFO_CFG
        {
            ...
            public byte byVCAType;       //�����������ͣ�VCA_CHAN_ABILITY_TYPE 
            public byte byStreamWithVCA; //�������Ƿ��������Ϣ
            public byte byMode;			//ģʽ��ATM ����ʱ����VCA_CHAN_MODE_TYPE ,TFS ����ʱ���� TFS_CHAN_MODE_TYPE���쳣��Ϊ���������ʱ����BEHAVIOR_SCENE_MODE_TYPE
            public byte byControlType;   //�������ͣ���λ��ʾ��0-��1-��
	                        //byControlType &1 �Ƿ�����ץ�Ĺ���
        ...
        public struct NET_DVR_POSITION_RULE_CFG_V41
        {
            ...
            public byte byTrackEnable; //�Ƿ�����_
            public byte byRes1;
            public ushort wTrackDuration; //_����ʱ�䣬��λs
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 76, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;         // �����ֽ�
        }
        ...
        public struct NET_DVR_TRACK_PARAMCFG
        {
            ...
            public ushort wTrackHoldTime;     // ����_����ʱ��  ��Χ0-300��
            public byte byTrackMode;        //  ���� IPDOME_TRACK_MODE
            public byte byPreDirection;	// _����Ԥ�� 0-������ 1-����
            public byte byTrackSmooth;	    // _����  0-������ 1-����
            public byte byZoomAdjust;	// ����ϵ������ �μ��±�
            public byte byMaxTrackZoom;	//���_����ϵ��,0-��ʾĬ�ϱ���ϵ��,�ȼ�6-�궨ֵ*1.0(Ĭ��),1-5Ϊ��С�궨ֵ��ֵԽС����С�ı���Խ��,7-15Ϊ�Ŵ�ֵԽ�󣬷Ŵ�ı���Խ��
            public byte byStopTrackWhenFindFace;  //������⵽���Ƿ�ֹͣ_ 0-�� 1-��
            public byte byStopTrackThreshold;   //_��ֹ������ֵ
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 9, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;          //  �����ֽ�                
        }
        ...
        {    
            ...
            public NET_DVR_PTZPOS struPtzPos;       //ptz ����
            public uint dwTrackTime;              //���_ʱ��[5,300] �룬TFS(��ͨȡ֤)ģʽ����Ч
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 24, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;               //����
        }
        ...
        public struct NET_DVR_PLATE_INFO
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_LICENSE_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byBelieve; //����ʶ���ַ������Ŷȣ����⵽����"��A_", ���Ŷ�Ϊ,20,30,40,50,60,70�����ʾ"��"����ȷ�Ŀ�����ֻ��%��"A"�ֵ���ȷ�Ŀ�������%
        }
        ...
        public struct NET_DVR_WHITEBALANCE
        {
            public byte byWhiteBalanceMode; /*0-�ֶ���ƽ�⣨MWB��,1-�Զ���ƽ��1��AWB1��,2-�Զ���ƽ��2 (AWB2),3-�Զ����Ƹ���Ϊ������ƽ��(Locked WB)��
	                         ...
	                         8-�Զ�_(Auto-Track)9-һ�ΰ�ƽ��(One Push)��10-�����Զ�(Auto-Outdoor)��
       ...
       public enum NET_SDK_DOWNLOAD_STATUS
       {
        ...
        public struct NET_MATRIX_RESOURSEGROUPPARAM
        {
            ...
            public byte byGroupType;/*0-�����CAM�飬1-��ʾ��MON��*/
            public byte byRes1;
        ...
        {
            public byte byAgeGroup;    //�����,�μ� HUMAN___GROUP_ENUM
            ...
            public byte byBeard;  //_, 0-��֧�֣�1-û��_��2-��_��0xff-unknow��ʾδ֪,�㷨֧��δ���
            public byte byRace;  //_, 0-��֧�֣�1-�����ˣ�2-_��3-_,0xff-unknow��ʾδ֪,�㷨֧��δ���
        ...
        public struct NET_VCA_HUMAN_ATTRIBUTE
        {
            ...
            public byte byAgeGroup;//����Σ����HUMAN___GROUP_ENUM���紫��0xff��ʾδ֪
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 11, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;//����
        }
        ...
        public struct NET_VCA_FACESNAP_INFO_ALARM
        {
            ...
            public byte byAge;//����
            public byte byAgeDeviation;//�������ֵ
            public byte byAgeGroup;//����Σ����HUMAN___GROUP_ENUM��������0xff��ʾδ֪
            /*������ͼͼƬ���������ȼ���0-�͵�����,1-�е�����,2-�ߵ�����,
        ...
        public struct NET_VCA_FACEMATCH_PICCOND
        {
            ...
            public uint dwBlockListID; //ƥ��ķ�׼������ID
            public uint dwBlockListFaceID; //�ȶԵķ�׼������������ͼID
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;              // �����ֽ�
        }
        ...
        public struct NET_VCA_FACEMATCH_PICTURE
        {
            ...
            public uint dwBlockListFaceLen; //�ȶԵķ�׼������������ͼ����
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;              //�����ֽ�
            public IntPtr pSnapFace;  //ץ��������ͼ��ͼƬ����
            public IntPtr pBlockListFace;  //�ȶԵķ�׼������������ͼ����
        }
        ...
        public struct NET_VCA_SINGLE_PATH
        {
            ...
            public byte byType;   //0-�洢ץ�ģ�1-�洢��׼�������ȶԱ�����2-�洢ץ�ĺͷ�׼�������ȶԱ�����0xff-��Ч
        ...
        public struct NET_DVR_DIAGNOSIS_UPLOAD
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = 64)]
            public string sMonitorIP;  ///< _��ip
            public uint dwChanIndex;  ///< _��ͨ����  
        ...
        public struct NET_DVR_ACS_EVENT_INFO
        {
            ...
            public byte byCardType; //�����ͣ�1-��ͨ����2-_����3-��׼����������4-Ѳ������5-в�ȿ���6-��������7-��������Ϊ0��Ч
        ...
        public struct NET_DVR_ID_CARD_INFO
        {
            ...
            public byte byNation;    //_��1-"��"��2-"�ɹ�"��3-"��",4-"��",5-"ά���",6-"��",7-"��",8-"׳",9-"����",10-"����",
        ...
        public struct NET_DVR_ID_CARD_INFO_ALARM
        {
            ...
            public uint dwPicDataLen;   //ͼƬ���ݴ�С����Ϊ0�Ǳ�ʾ���������
            public IntPtr pPicData;
            public byte byCardType; //�����ͣ�1-��ͨ����2-_����3-��׼����������4-Ѳ������5-в�ȿ���6-��������7-��������8-�������Ϊ0��Ч
        ...
        public struct NET_DVR_CARD_CFG_V50
        {
            ...
            public byte byCardType; //�����ͣ�1-��ͨ����2-_����3-��׼����������4-Ѳ������5-в�ȿ���6-��������7-��������8-�������9-Ա������10-Ӧ������11-Ӧ����������������Ȩ��ʱ��Ȩ�ޣ��������ܿ��ţ���Ĭ����ͨ��
        ...
        public enum IVS_PARAM_KEY
        {
            ...
            MISSING_OBJECT_HOLD = 7,//Ŀ����ʧ�����_ʱ��
            MAX_MISSING_DISTANCE = 8,//Ŀ����ʧ�����_����
        ...
        public struct NET_DVR_LF_TRACK_MODE
        {
            ...
            public struct uModeParam
            {
                ...
                public uint[] dwULen;
                /*[FieldOffsetAttribute(0)]
                public NET_DVR_LF_MANUAL_CTRL_INFO struManualCtrl;//�ֶ�_�ṹ
                [FieldOffsetAttribute(0)]
                public NET_DVR_LF_TRACK_TARGET_INFO struTargetTrack;//Ŀ��_�ṹ
                 * */
            }
        }
        ...
        */
        ...
        public struct NET_VCA_PLATE_INFO
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValTStr, SizeConst = MAX_LICENSE_LEN)]
            public string sBelieve;//����ʶ���ַ������Ŷȣ����⵽����"��A_", ���Ŷ�Ϊ10,20,30,40,50,60,70�����ʾ"��"����ȷ�Ŀ�����ֻ��10%��"A"�ֵ���ȷ�Ŀ�������20%
        }
